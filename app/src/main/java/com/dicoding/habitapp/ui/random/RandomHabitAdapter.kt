...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            val pagerIvPriority = itemView.findViewById<ImageView>(R.id.pager_priority_level)
            ...
            val btnOpenCountDown = itemView.findViewById<TextView>(R.id.btn_open_count_down)
